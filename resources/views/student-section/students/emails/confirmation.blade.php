                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr style="vertical-align:top">
                                                                                                <td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;width:100%;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px" align="center">
                                                                                                    <div align="center">
                                                                                                        <img style="outline:none;text-decoration:none;clear:both;display:block;border:0;height:auto;line-height:100%;margin:0 auto;float:none;max-height:64px" alt="{{ config('app.name') }}" title="{{ config('app.name') }}" border="0" align="middle" src="{{ env('APP_URL') . '/assets/img/email-logo' . '.png' }}">
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                                ...
                                                                                                <td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;padding-top:60px;padding-right:30px;padding-bottom:30px;padding-left:30px;text-align:left" align="left">
                                                                                                    <div style="color:#555555;line-height:120%;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif">
                                                                                                        <div style="font-size:14px;line-height:15px;color:#555555;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif">
                                                                                                            <p style="margin:0 0 10px 0;font-size:15px;line-height:27px">
                                                                                                                Hi {{ $student_name }}, <br><br>
                                                                                                                Congratulations! You have completed the first phase of your application process. 

                                                                                                            </p>
                                                                                                            <p style="margin:0 0 10px 0;font-size:15px;line-height:24px">
                                                                                                                To determine your eligibility, we will review your documents and possibly, give you a call to provide more information on the programme you have opted for or counsel you on more suitable options.   
                                                                                                            </p>
                                                                                                            <p style="margin:0 0 10px 0;font-size:15px;line-height:24px">
                                                                                                                Upon confirmation, you will receive an email containing a breakdown of fees and bank details to make payment. Kindly make payment and proceed to any of our centres with a copy of your bank teller/receipt. 
                                                                                                            </p><br>
                                                                                                            ...
                                                                                                            <p style="margin:0 0 10px 0;font-size:15px;line-height:24px">
                                                                                                                For questions and further enquiries, please call: {{ config('app.phone1') }}, {{ config('app.phone3') }}, {{ config('app.phone4') }}, {{ config('app.phone5') }} or send an email to: {{ config('app.info_email') }} 
                                                                                                            </p><br>
                                                                                                            ...
                                                                                                            <p style="margin:0 0 10px 0;font-size:14px;line-height:22px">
                                                                                                                Like our Facebook Page: <a href="{{ config('app.facebook_link') }}" target="_blank">{{ config('app.facebook_link') }}</a><br>
                                                                                                                Follow us on Instagram: <a href="{{ config('app.instagram_link') }}" target="_blank">{{ config('app.instagram_link') }}</a><br>
                                                                                                                Follow us on Twitter: <a href="{{ config('app.twitter_link') }}" target="_blank">{{ config('app.twitter_link') }}</a>
                                                                                                            </p>

                                                                                                            <div style="margin-top:40px;margin-bottom:20px;height:1px;background:#e5e5e5"></div>

                                                                                                             <p style="margin:0 0 10px 0;font-size:13px;line-height:20px;text-align:justify;">
                                                                                                                <b>DISCLAIMER</b><br>
                                                                                                                This email and any files transmitted with it are confidential and are solely for the use of the individual 
                                                                                                                or entity to which it is addressed. Any use, distribution, copying or disclosure by any other person is 
                                                                                                                strictly prohibited. If you receive this transmission in error, please notify the sender by reply email 
                                                                                                                and then destroy the message. Opinions, conclusions and other information in this message that do not 
                                                                                                                relate to official business of the company shall be understood to be neither given nor endorsed by {{ config('app.name') }}. 
                                                                                                                Any information contained in this email, when addressed to Clients is subject to the terms and conditions 
