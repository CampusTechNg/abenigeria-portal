                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group{{ $errors->has('dob') ? ' text-danger' : '' }}">
                                                <div class="form-material">
                                                    <input type="text" class="js-datepicker form-control" id="dob" name="dob" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" value="{{ $student->dob or old('dob') }}">
                                                    @if ($errors->has('dob'))
                                                        <span class="help-block">
